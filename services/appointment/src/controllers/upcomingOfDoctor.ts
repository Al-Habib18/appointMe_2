...
import { getUpcomingAppointmentsByDoctortId } from "@lib/index";
import { queryParamsSchema, idParamSchema } from "@schemas/index";

const upcomingOfDoctorController = async (req: Request, res: Response) => {
    try {
        ...
        const appointments = await getUpcomingAppointmentsByDoctortId(id, data);
...
export default upcomingOfDoctorController;
